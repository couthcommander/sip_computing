...
hist(dataForAnalysis$nc1)
hist(log(dataForAnalysis$nc1))

hist(dataForAnalysis$nc2)
hist(log(dataForAnalysis$nc2))
...
(3) Make residual plot to assess the homogeneity of variances assumption.
