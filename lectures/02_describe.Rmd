...
The summary of discrete data usually includes mean, standard deviation, and quantiles. It may also include number of observations and number of observations missing. Continuous data is often summarized with a frequency table.
...
Here's a link to the description of the profile data: [biopro](https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_BIOPRO.htm)
...
demo <- as.data.frame(haven::read_xpt('https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_DEMO.XPT'))[, c('SEQN','RIAGENDR','RIDAGEYR')]
# read profile data
dat <- as.data.frame(haven::read_xpt('https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_BIOPRO.XPT'))
...
There are many ways we can produce a plot to visually inspect our data. Here's one example, were we take a closer look at the bicarbonate variable. We'll use the `ggplot2` package to create a density plot.
